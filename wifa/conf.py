...
BLOG_AUTHOR = "WIFA"  # (translatable)
BLOG_TITLE = "Women's Internet Freedom Alliance"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://womensinternetfreedom.org/"
...
GITHUB_SOURCE_BRANCH = 'deploy-src'
